...
export default function UpdateUserModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      openWarning('고객사 정보 변경 실패', e?.message ?? '고객사 정보 변경 중 오류가 발생했습니다.');
    }
  };
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      openWarning('고객사 삭제 실패', e?.message ?? '고객사 삭제 중 오류가 발생했습니다.');
    }
  };
    ...
    <>
      ...
      <S.ModalWrap role="dialog" aria-modal="true" aria-labelledby="update-company-title">
        <S.ModalHead>
          ...
          <S.CloseButton type="button" onClick={onClose} aria-label="닫기" disabled={isBusy}>
            ×
          </S.CloseButton>
        </S.ModalHead>

        <S.ModalBody>
          <S.BodyTitle id="update-company-title">고객사 정보변경</S.BodyTitle>
          <S.BodyDescription>변경하고자 하는 고객사의 정보를 입력해주세요.</S.BodyDescription>
          ...
          <S.Form>
            ...
            <S.Field>
              ...
              <S.Input
                ...
                disabled={isBusy}
              />
              {errors.newPasswordConfirm && <S.ErrorText>{errors.newPasswordConfirm}</S.ErrorText>}
            </S.Field>
